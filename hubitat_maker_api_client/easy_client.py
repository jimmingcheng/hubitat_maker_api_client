...
class HubitatEasyClient():
    ...
    def get_contact_sensors(self):
        return self.get_device_aliases_by_capability('ContactSensor')

    def get_door_controls(self):
        return self.get_device_aliases_by_capability('DoorControl')

    def get_locks(self):
        return self.get_device_aliases_by_capability('Lock')

    def get_motion_sensors(self):
        return self.get_device_aliases_by_capability('MotionSensor')

    def get_switches(self):
        return self.get_device_aliases_by_capability('Switch')

    def get_users(self):
        return self.get_device_aliases_by_capability('PresenceSensor')

    # Device accessors with attribute filters
    def get_open_doors(self):
        return self.get_device_aliases_by_capability_and_attribute('ContactSensor', 'contact', 'open')

    def get_unlocked_doors(self):
        return self.get_device_aliases_by_capability_and_attribute('Lock', 'lock', 'unlocked')

    def get_active_motion(self):
        return self.get_device_aliases_by_capability_and_attribute('MotionSensor', 'motion', 'active')

    def get_on_switches(self):
        return self.get_device_aliases_by_capability_and_attribute('Switch', 'switch', 'on')
